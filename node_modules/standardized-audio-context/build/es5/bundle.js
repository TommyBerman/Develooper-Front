(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('automation-events'), require('@babel/runtime/helpers/classCallCheck'), require('@babel/runtime/helpers/slicedToArray'), require('@babel/runtime/helpers/typeof'), require('@babel/runtime/helpers/defineProperty'), require('@babel/runtime/helpers/createClass'), require('@babel/runtime/helpers/possibleConstructorReturn'), require('@babel/runtime/helpers/getPrototypeOf'), require('@babel/runtime/helpers/inherits'), require('@babel/runtime/regenerator'), require('@babel/runtime/helpers/asyncToGenerator'), require('@babel/runtime/helpers/toConsumableArray'), require('@babel/runtime/helpers/assertThisInitialized'), require('@babel/runtime/helpers/objectWithoutProperties')) :
...
}(this, function (exports, automationEvents, _classCallCheck, _slicedToArray, _typeof, _defineProperty, _createClass, _possibleConstructorReturn, _getPrototypeOf, _inherits, _regeneratorRuntime, _asyncToGenerator, _toConsumableArray, _assertThisInitialized, _objectWithoutProperties) { 'use strict';
    ...
    var AUDIO_BUFFER_STORE = new WeakSet();
    ...
    var PERIODIC_WAVE_STORE = new WeakSet();
    ...
    var createAddAudioWorkletModule = function createAddAudioWorkletModule(createAbortError, createNotSupportedError, exposeCurrentFrameAndCurrentTime, fetchSource, getBackupNativeContext, ongoingRequests, resolvedRequests) {
      return function (context, moduleURL) {
        ...
        var promise = fetchSource(moduleURL).then(function (source) {
          ...
          exposeCurrentFrameAndCurrentTime(nativeContext, function () {
        ...
        function () {
          function AudioBuffer(options) {
            ...
            if (typeof audioBuffer.copyFromChannel !== 'function') {
              ...
              wrapAudioBufferCopyChannelMethodsOutOfBounds(audioBuffer); // Bug #157: No browser does allow the bufferOffset to be out-of-bounds.
    ...
    var addAudioNode = function addAudioNode(context, audioNode, audioNoderRender, nativeAudioNode) {
      ...
      var _getAudioGraph = getAudioGraph(context),
          nodes = _getAudioGraph.nodes;
    ...
    var createAudioNodeConstructor = function createAudioNodeConstructor(cacheTestResult, createIndexSizeError, createInvalidAccessError, createNotSupportedError, detectCycles, isNativeAudioNode, isNativeAudioParam, isNativeOfflineAudioContext) {
      return (
        /*#__PURE__*/
    ...
    var createAudioParamFactory = function createAudioParamFactory(createAudioParamRenderer, createCancelAndHoldAutomationEvent, createCancelScheduledValuesAutomationEvent, createExponentialRampToValueAutomationEvent, createLinearRampToValueAutomationEvent, createSetTargetAutomationEvent, createSetValueAutomationEvent, createSetValueCurveAutomationEvent, nativeAudioContextConstructor) {
    ...
    function () {
      var _ref = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee(proxy, renderedBuffer, nativeOfflineAudioContext, options, processorConstructor) {
      ...
      return function (name, options, processorConstructor) {
        ...
        function () {
          ...
          _regeneratorRuntime.mark(function _callee4(proxy, nativeOfflineAudioContext) {
            var nativeAudioWorkletNode, nativeOutputNodes, nativeAudioWorkletNodeIsOwnedByContext, numberOfOutputChannels, outputChannelSplitterNode, outputChannelMergerNodes, i, outputAudioNodes, outputGainNode, _nativeOutputNodes, _nativeOutputNodes2, _outputChannelSplitterNode, _outputChannelMergerNodes, _outputGainNode, _numberOfInputChannels, numberOfParameters, partialOfflineAudioContext, gainNodes, inputChannelSplitterNodes, _i, constantSourceNodes, inputChannelMergerNode, _i2, j, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _step$value, index, constantSourceNode, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _step2$value, nm, audioParam, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _step3$value;
                  ...
                  case 41:
                    ...
                    function () {
                      ...
                      _regeneratorRuntime.mark(function _callee3(renderedBuffer) {
                        var audioBufferSourceNode, processedBuffer, _i3, outputChannelSplitterNodeOutput, outputChannelMergerNode, _j3;
                          ...
                          while (1) {
                            switch (_context3.prev = _context3.next) {
                              case 0:
                                ...
                                _context3.next = 3;
                                return processBuffer(proxy, renderedBuffer, nativeOfflineAudioContext, options, processorConstructor);
                              ...
                              case 3:
                                ...
                                for (_i3 = 0, outputChannelSplitterNodeOutput = 0; _i3 < proxy.numberOfOutputs; _i3 += 1) {
                                  ...
                                  for (_j3 = 0; _j3 < options.outputChannelCount[_i3]; _j3 += 1) {
                                    _outputChannelSplitterNode.connect(outputChannelMergerNode, outputChannelSplitterNodeOutput + _j3, _j3);
                                  }

                                  outputChannelSplitterNodeOutput += options.outputChannelCount[_i3];
                                }

                                return _context3.abrupt("return", _outputGainNode);
            ...
            }, _callee4, null, [[25, 29, 33, 41], [34,, 36, 40], [47, 58, 62, 70], [63,, 65, 69], [75, 86, 90, 98], [91,, 93, 97]]);
          }));

          return function createAudioNode(_x6, _x7) {
        ...
        return {
          render: function render(proxy, nativeOfflineAudioContext) {
            var renderedNativeAudioWorkletNodeOrOutputNodes = renderedNativeAudioNodes.get(nativeOfflineAudioContext);

            if (renderedNativeAudioWorkletNodeOrOutputNodes !== undefined) {
              var renderedNativeAudioWorkletNodeOrGainNode = Array.isArray(renderedNativeAudioWorkletNodeOrOutputNodes) ? renderedNativeAudioWorkletNodeOrOutputNodes[2] : renderedNativeAudioWorkletNodeOrOutputNodes;
    ...
    var createCacheTestResult = function createCacheTestResult(ongoingTests) {
    ...
    var createDetectCycles = function createDetectCycles(audioParamAudioNodeStore, createNotSupportedError, getAudioNodeConnections, getValueForKey) {
      return function detectCycles(source, destination) {
        var audioNodeOfDestination = isAudioNode(destination) ? destination : getValueForKey(audioParamAudioNodeStore, destination);
        ...
        var _getAudioNodeConnecti = getAudioNodeConnections(audioNodeOfDestination),
    ...
    var createExposeCurrentFrameAndCurrentTime = function createExposeCurrentFrameAndCurrentTime(window) {
      return function (nativeContext, fn) {
    ...
    var createIIRFilterNodeRendererFactory = function createIIRFilterNodeRendererFactory(createNativeAudioBufferSourceNode, createNativeAudioNode, nativeOfflineAudioContextConstructor, renderNativeOfflineAudioContext) {
      return function (feedback, feedforward) {
        ...
        function () {
          ...
          /*#__PURE__*/
          _regeneratorRuntime.mark(function _callee(proxy, nativeOfflineAudioContext) {
            var nativeIIRFilterNode, nativeAudioBufferSourceNode, nativeIIRFilterNodeIsOwnedByContext, partialOfflineAudioContext, renderedBuffer;
            return _regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                  ...
                  case 19:
                    return _context.abrupt("return", nativeIIRFilterNode);
      ...
      return (
        ...
        function (_noneAudioDestination) {
          ...
          function MediaStreamAudioSourceNode(context, options) {
            ...
            _this = _possibleConstructorReturn(this, _getPrototypeOf(MediaStreamAudioSourceNode).call(this, context, 'active', nativeMediaStreamAudioSourceNode, null));
          ...
          if (audioWorkletProcessor !== null) {
            var _loop2 = function _loop2(_i4) {
              ...
              try {
                ...
                var activeSourceFlag = exposeCurrentFrameAndCurrentTime(nativeContext, function () {
                ...
                for (var _j4 = 0, _outputChannelSplitterNodeOutput = 0; _j4 < options.numberOfOutputs; _j4 += 1) {
                  for (var _k2 = 0; _k2 < options.outputChannelCount[_j4]; _k2 += 1) {
                    copyToChannel(outputBuffer, outputs[_j4], _k2, _outputChannelSplitterNodeOutput + _k2, _i4);
                  }
    ...
    var createPeriodicWaveConstructor = function createPeriodicWaveConstructor(createNativePeriodicWave, periodicWaveStore) {
      return (
        /*#__PURE__*/
        function () {
    ...
    var createStartRendering = function createStartRendering(audioBufferStore, cacheTestResult, renderNativeOfflineAudioContext, testAudioBufferCopyChannelMethodsOutOfBoundsSupport, testAudioBufferCopyChannelMethodsSubarraySupport, wrapAudioBufferCopyChannelMethods, wrapAudioBufferCopyChannelMethodsOutOfBounds, wrapAudioBufferCopyChannelMethodsSubarray) {
    ...
    var createWrapAudioBufferCopyChannelMethodsSubarray = function createWrapAudioBufferCopyChannelMethodsSubarray(convertNumberToUnsignedLong, createIndexSizeError) {
      return function (audioBuffer) {
        audioBuffer.copyFromChannel = function (copyFromChannel) {
          return function (destination, channelNumberAsNumber) {
            var bufferOffsetAsNumber = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
    ...
    var cacheTestResult = createCacheTestResult(new Map());
    ...
    var audioNodeConstructor = createAudioNodeConstructor(cacheTestResult, createIndexSizeError, createInvalidAccessError, createNotSupportedError, createDetectCycles(AUDIO_PARAM_AUDIO_NODE_STORE, createNotSupportedError, getAudioNodeConnections, getValueForKey), isNativeAudioNode$1, isNativeAudioParam, isNativeOfflineAudioContext);
    ...
    var wrapAudioBufferCopyChannelMethodsSubarray = createWrapAudioBufferCopyChannelMethodsSubarray(convertNumberToUnsignedLong, createIndexSizeError);
    var audioBufferConstructor = createAudioBufferConstructor(AUDIO_BUFFER_STORE, cacheTestResult, createNotSupportedError, nativeAudioBufferConstructor, nativeOfflineAudioContextConstructor, createTestAudioBufferConstructorSupport(nativeAudioBufferConstructor), wrapAudioBufferCopyChannelMethods, wrapAudioBufferCopyChannelMethodsOutOfBounds, wrapAudioBufferCopyChannelMethodsSubarray);
    ...
    var createAudioParam = createAudioParamFactory(createAudioParamRenderer, automationEvents.createCancelAndHoldAutomationEvent, automationEvents.createCancelScheduledValuesAutomationEvent, automationEvents.createExponentialRampToValueAutomationEvent, automationEvents.createLinearRampToValueAutomationEvent, automationEvents.createSetTargetAutomationEvent, automationEvents.createSetValueAutomationEvent, automationEvents.createSetValueCurveAutomationEvent, nativeAudioContextConstructor);
    ...
    var periodicWaveConstructor = createPeriodicWaveConstructor(createNativePeriodicWave, PERIODIC_WAVE_STORE);
    ...
    var addAudioWorkletModule = isSecureContext ? createAddAudioWorkletModule(createAbortError, createNotSupportedError, exposeCurrentFrameAndCurrentTime, createFetchSource(createAbortError), getBackupNativeContext, new WeakMap(), new WeakMap()) : undefined;
    ...
    var decodeAudioData = createDecodeAudioData(AUDIO_BUFFER_STORE, cacheTestResult, createDataCloneError, createEncodingError, nativeOfflineAudioContextConstructor, isNativeContext, isNativeOfflineAudioContext, testAudioBufferCopyChannelMethodsOutOfBoundsSupport, testAudioBufferCopyChannelMethodsSubarraySupport, testPromiseSupport, wrapAudioBufferCopyChannelMethods, wrapAudioBufferCopyChannelMethodsOutOfBounds, wrapAudioBufferCopyChannelMethodsSubarray);
    ...
    var startRendering = createStartRendering(AUDIO_BUFFER_STORE, cacheTestResult, renderNativeOfflineAudioContext, testAudioBufferCopyChannelMethodsOutOfBoundsSupport, testAudioBufferCopyChannelMethodsSubarraySupport, wrapAudioBufferCopyChannelMethods, wrapAudioBufferCopyChannelMethodsOutOfBounds, wrapAudioBufferCopyChannelMethodsSubarray);
