...
declare type ClockCallback = (time: Time, ticks?: Ticks) => void;
 ...
 * @category Core
 */
export declare class Clock<Type extends BPM | Hertz = Hertz> extends ToneWithContext<ClockOptions> implements Emitter<ClockEvent> {
