...
var MetalSynth = /** @class */ (function (_super) {
    ...
    MetalSynth.prototype._triggerEnvelopeAttack = function (time, velocity) {
        ...
        if (this.envelope.sustain === 0) {
            this._oscillators.forEach(function (osc) {
                osc.stop(_this.toSeconds(time) + _this.toSeconds(_this.envelope.attack) + _this.toSeconds(_this.envelope.decay));
            });
        }
        return this;
    };
    ...
    MetalSynth.prototype._triggerEnvelopeRelease = function (time) {
        ...
        this._oscillators.forEach(function (osc) { return osc.stop(_this.toSeconds(time) + _this.toSeconds(_this.envelope.release)); });
        return this;
    };
